...
public enum ThemeColor {
    ...
    TEXT_INPUT_NORMAL("text.input.normal", 0xFFFFFFFF), TEXT_INPUT_FOCUSED("text.input.focused", 0xFFFFFFFF),
    TEXT_INPUT_SELECTION("text.input.selection", 0xFF00FF00), TEXT_INPUT_ERROR("text.input.error", 0xFFFF1900),

    FOREGROUND_INPUT_NORMAL("foreground.input.normal", 0xFFA8A8A8),
    FOREGROUND_INPUT_FOCUSED("foreground.input.normal", 0xFF606060),
