...
public class ThemeConfig {
    ...
    /**
     * Get the configurable item it will change dynamically when the configuration is reload.
     */
    ...
    /**
     * Get the configurable color item it will change dynamically when the configuration is reload.
     */
